...
These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Selina Kutz, doing business as Moon Development ("Moon Development", “we”, “us”, or “our”), concerning your access to and use of the applications and bots developed by Moon Development as well as any other media form, website, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Bot”). You agree that by accessing the Bot (inviting the Bot and/or using its commands and other features), you have read, understood, and agree to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE BOT AND YOU MUST DISCONTINUE USE IMMEDIATELY.

We reserve the right to update these terms at any time without prior notice. By using the Bot, you are agreeing to be bound by the current version of these Terms and Conditions of Use. Please ensure that you check the applicable Terms every time you use the Bot so that you understand which Terms apply.

The Bot may not be used by users under the minimal age described in Discord's [Terms of Service](https://discord.com/terms). All users who are minors in the jurisdiction in which they reside (generally under the age of 18) must have the permission of, and be directly supervised by, their parent or guardian to use the Bot. If you are a minor, you must have your parent or guardian read and agree to these Terms of Use prior to you using the Bot.  
...
**Moon Development** is not affiliated with, supported or made by Discord.
...
- Break any of Discord's [Terms of Service](https://discord.com/terms) through the Bot or by using the Bot.
...
These conditions are governed by and interpreted following the laws of Germany, and the use of the United Nations Convention of Contracts for the International Sale of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law of your country of residence. Selina Kutz and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Hesse, which means that you may make a claim to defend your consumer protection rights in regards to these Conditions of Use in Germany, or in the EU country in which you reside.
